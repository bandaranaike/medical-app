                    ...
                    <table className="w-full text-sm text-left text-gray-400">
                        ...
                        {bills.map((bill) => (
                            <tr key={bill.id} className="border-t">
                                <td className="px-4 py-2 border-r">{bill.id}</td>
                                <td className="px-4 py-2 border-r">{bill.queue_number}</td>
                                <td className="px-4 py-2 border-r"><StatusLabel status={bill.status}/></td>
                                <td className="px-4 py-2 border-r">{bill.doctor_name}</td>
                                <td className="px-4 py-2 border-r">{bill.appointment_type}</td>
                                <td className="px-4 py-2 border-r">{bill.patient_name}</td>
                                <td className="px-4 py-2 border-r">{(Number(bill.bill_amount) + Number(bill.system_amount)).toFixed(2)}</td>
                                <td className="px-4 py-2 border-r">{bill.queue_date}</td>
                                <td className="px-4 py-2 border-r">{bill.payment_status}</td>
